...
class RenameItem(SQLModel, table=True):
    ...
    disk_scenario: str = "unknown"  # rename | arr_only | disk_only | collision | missing | unknown
    item_type: str = Field(default="folder")  # "folder" or "file"
    source_file_id: Optional[int] = None      # arr movieFileId / episodeFileId (file items only)
