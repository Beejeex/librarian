"""
ntfy.sh notification integration for MadTracked.
...
async def send_notification_async(
    ...
    *,
    ...
    """Async wrapper — runs send_notification() in a thread pool to avoid blocking the event loop."""
...
async def notify_first_run_complete(
    ...
    await send_notification_async(
        ...
        message=f"{count} {noun} queued as backlog — approve in MadTracked to start copying.",
        priority="default",
        tags=["mag"],
    )
